...
public enum ExceptionCode {
  ...
  USER_STATUS_ALREADY_EXIST(400, "USER_STATUS_ALREADY_EXIST", "이미 존재하는 사용자 상태"),
  //CHANNEL
  CHANNEL_NOT_FOUND(404, "CHANNEL_NOT_FOUND", "존재하지 않는 채널"),
  CHANNEL_ALREADY_EXIST(400, "CHANNEL_ALREADY_EXIST", "이미 존재하는 채널"),
  NOT_ALLOWED_IN_PRIVATE_CHANNEL(400, "NOT_ALLOWED_IN_PRIVATE_CHANNEL", "비공개 채널에 허용되지 않은 기능"),
  //READ_STATUS
  READ_STATUS_NOT_FOUND(404, "READ_STATUS_NOT_FOUND", "존재하지 않는 읽기 상태(멤버) 정보"),
  READ_STATUS_ALREADY_EXIST(400, "READ_STATUS_ALREADY_EXIST", "이미 존재하는 읽기 상태(멤버)"),
  //MESSAGE
